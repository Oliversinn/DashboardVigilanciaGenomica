                              ...
                              tabItem(
                                ...
                                fluidRow(
                                  ...
                                  box(
                                    ...
                                    tags$p(tags$b('Variante de Preocupación (VOC):'), 'tiene las mismas características que una VOI, pero con evidencia científica del cambio en el comportamiento del virus (transmisión, gravedad de síntomas, escape de la inmunidad, entre otras) o que fue categorizada como tal por la OMS.'),
